        ...
        <div class="modal-content">
            <div class="card new-contact">
                <header class="content__title">
                    <h1 style="text-align: center;padding-top: 10px;">Добавить каталог</h1>
                </header>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
            ...
            <script>
                ...
                button.on('click', function(e) {
                    ...
                    $.ajax({
                        url: '{{route("admin-catalog-create")}}',
                        type: "POST",
                        data: $data,
                        processData: false,
                        contentType: false,
                        success: function(data) {
                            swal.fire({
                                ...
                                title: "Успешно!",
                                text: "Вы успешно создали новый каталог!",
                                background: "#000",
...
<script>
    ...
    new DataTable(table, {
        ...
        columns: [{
                ...
                },
            {
                ...
                orderable: false,
                render: function(data, type, row) {
                    return `<a href="{{route("admin-catalog")}}/` + row.id + `" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Редактировать"><i class="zwicon-pencil"></i></a>
    ...
    function portfoliosDistroy($id) {
        window.location.href = "{{route('admin-catalog-delete')}}/" + $id;
    }
</script>
@endsection
