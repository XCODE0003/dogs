        ...
        <div class="modal-content">
            <div class="card new-contact">
                <header class="content__title">
                    <h1 style="text-align: center;padding-top: 10px;">Добавить отзыв</h1>
                </header>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Каталог</label>
                                <select class="select2 select2-hidden-accessible" name="categorie_id" data-minimum-results-for-search="10" data-placeholder="Выберите каталог" aria-hidden="true">
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <!-- <form class="dropzone" id="add-portfolio" action="/" maxFiles="1"></form> -->
                            <div class="summernoteExample" data-name="description"></div>
                        </div>
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            swal.fire({
                                ...
                                title: "Успешно!",
                                text: "Вы успешно создали новый отзыв!",
                                background: "#000",
...
<script>
        ...
        columns: [{
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    return '<img src="' + data +
                        '" style="width:45px;height: 45px;border-radius:5px;margin-right:10px;vertical-align:middle;">';
                }
            },
            {
                data: "category.title",
            ...
            },
            {
                ...
                orderable: false,
                render: function(data, type, row) {
                    return `<a href="{{route("admin-review")}}/` + row.id + `" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Редактировать"><i class="zwicon-pencil"></i></a>
    ...
    function portfoliosDistroy($id) {
        window.location.href = "{{route('admin-review-delete')}}/" + $id;
    }
</script>
@endsection
